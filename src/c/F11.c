...
//     int totalRooms = rumahsakit.roomCol * rumahsakit.roomRow;
//     boolean dokterFound = false;
//     boolean pasienFound = false;
    
//     for (int i = 0; i < totalRooms; i++) {
//         if (rumahsakit.room[i].idDokter == loginId) {
//             dokterFound = true;
            
//             for (int j = 0; j < rumahsakit.roomCapacity; j++) {
//                 int idPasien = rumahsakit.room[i].ruangan[j]; 
